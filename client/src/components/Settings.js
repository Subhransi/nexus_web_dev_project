...
const Settings = ({ settings, updateSettings }) => {
  ...
  useEffect(() => {
    if (settings) {
      // Ensure formData includes darkMode when settings come from API
      setFormData({
  ...
  // Instant preview for dark mode toggle (client-side only until saved)
  useEffect(() => {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="settings-section">
            ...
            <div className="form-group">
              ...
              <p className="help-text">Toggle to switch the app between light and dark themes. Preview applies immediately; save to persist.</p>
            </div>
          </div>
